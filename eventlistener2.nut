...
function FireEventFormat(id ,event_data) {
    ...
    switch (args.len()) {
	    case 0:
            ...
            break
	    case 1:
            getroottable()[name](args[1])
            break
	    case 2:
            getroottable()[name](args[1],args[2])
            break
	    case 3:
            getroottable()[name](args[1],args[2],args[3])
            break
	    case 4:
            getroottable()[name](args[1],args[2],args[3],args[4])
            break
	    case 5:
            getroottable()[name](args[1],args[2],args[3],args[4],args[5]);
            break
	    case 6:
            getroottable()[name](args[1],args[2],args[3],args[4],args[5],args[6])
            break
	    case 7:
            getroottable()[name](args[1],args[2],args[3],args[4],args[5],args[6],args[7])
            break
	    case 8:
            getroottable()[name](args[1],args[2],args[3],args[4],args[5],args[6],args[7],args[8])
            break
	    case 9:
            getroottable()[name](args[1],args[2],args[3],args[4],args[5],args[6],args[7],args[8],args[9])
            break
	    case 10:
            getroottable()[name](args[1],args[2],args[3],args[4],args[5],args[6],args[7],args[8],args[9],args[10])
            break
    }
}

//Used for assign user ids 
function userid_assigner(params) {
...
/*
//监听伤害
::OnGameEvent_player_hurt <- function (player,attacker,health,armor,weapon,dmg_health,dmg_armor,hitgroup) {
